...
export class PaymeService {
    ...
    async checkPerformTransaction(
        ...
        const selectedSport = checkPerformTransactionDto.params?.account?.selected_sport;

        logger.info(`LOOK new ADDED field is here in checkPerformTransaction: ${selectedSport}`);
    ...
    async createTransaction(createTransactionDto: CreateTransactionDto) {
        ...
        logger.info(`LOOK new ADDED field is here in createTransaction: ${selectedSport}`);
        ...
        logger.info(`Selected sport before createTransaction: ${selectedSport}`);
        ...
        logger.info(`Selected sport after createTransaction: ${newTransaction.selectedSport}`);
    ...
    async performTransaction(performTransactionDto: PerformTransactionDto) {
        ...
        const plan = await planModel.findById(transaction.planId).exec();
        ...
        try {
            const selectedSport = transaction.selectedSport;
            logger.info(`Selected sport in performTransaction: ${selectedSport}`);
